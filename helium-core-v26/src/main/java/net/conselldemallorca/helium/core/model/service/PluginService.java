...
public class PluginService {
	...
	private boolean processarDocumentPendentPortasignatures(
		...
		if (portasignatures != null) {
			...
			JbpmToken token = workflowEngineApi.getTokenById(tokenId.toString());
	...
	private void afegirDocumentCustodia(
		...
		if (document != null) {
			JbpmProcessInstance rootProcessInstance = workflowEngineApi.getRootProcessInstance(documentStore.getProcessInstanceId());
