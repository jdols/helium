...
public class DocumentHelper {
	...
	public Long actualitzarDocument(
		...
		if (arxiuContingut != null && pluginHelper.gestioDocumentalIsPluginActiu()) {
			ProcessInstanceExpedient expedient = workflowEngineApi.expedientFindByProcessInstanceId(processInstanceId);
	...
	private Document getDocumentDisseny(
		...
		if (taskInstanceId != null) {
			JbpmTask taskInstance = workflowEngineApi.getTaskById(taskInstanceId);
